        ...
        <div class="space-y-4 rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900/50 shadow-sm"
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-zinc-500">{{ __('Showcase your event with up to 3 images') }}</p>
                </div>
            ...
            <div class="relative min-h-[160px] w-full"
                ...
                @else
                    ...
                    <div class="grid grid-cols-3 gap-4" wire:key="media-grid-{{ count($images) + count($newImages) }}">
