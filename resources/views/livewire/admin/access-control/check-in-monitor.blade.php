<div>
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
        <div class="flex items-center gap-3">
            ...
            <div class="ml-4 flex items-center px-3 py-1 bg-zinc-100 dark:bg-zinc-800 rounded-full text-sm font-semibold">
                <span class="mr-2 h-2 w-2 rounded-full bg-blue-500 animate-pulse"></span>
                <span>{{ __('Live Occupancy:') }} <span class="tabular-nums" x-data="{ count: @entangle('occupancyCount') }" x-text="count"></span></span>
            </div>
        </div>
