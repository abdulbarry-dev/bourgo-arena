<x-layouts::app :title="__('Subscription Detail')">
    <section class="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        <x-ui.dashboard.page-header
            ...
            :subtitle="__('Review subscription information, payment context, and recent audit events.')"
        />

        <x-ui.dashboard.panel>
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-4">
                    <x-ui.dashboard.member-avatar :member="$subscription->member" size="lg" rounded="xl" />
                    <div>
