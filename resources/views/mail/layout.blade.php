  ...
  <div style="width: 100%; max-width: 520px;">
    ...
    <div style="text-align: center; margin-bottom: 12px;">
      <div style="display: inline-flex; align-items: baseline; gap: 0; font-size: 22px; font-weight: 900; letter-spacing: 0.06em; text-transform: uppercase;">
        <span style="color: #ffffff;">BOURGO</span>
        <span style="color: #c8f000;">&nbsp;ARENA</span>
      </div>
      <div style="font-size: 9px; letter-spacing: 0.25em; color: #888888; text-transform: uppercase; margin-top: 4px;">Le QG du Sport à Djerba</div>
    </div>
    ...
    <div style="text-align: center; margin-top: 28px;">
      <div style="font-size: 11px; color: #555555; line-height: 1.7;">
        Bourgo Arena Complex, Djerba, Tunisie<br>
