...
class SubscriptionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $subscriptions = [
            ...
            ['email' => 'nadia.rachid@example.com', 'plan' => 'Annual Elite', 'status' => 'active', 'starts_at' => now()->subDays(90)->toDateString(), 'ends_at' => now()->addDays(275)->toDateString(), 'payment_method' => 'konnect', 'payment_reference' => 'SUB-2026-0005', 'amount_paid' => 1199.000],
