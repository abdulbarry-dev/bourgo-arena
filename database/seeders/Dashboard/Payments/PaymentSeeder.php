...
class PaymentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $paymentRows = [
            ...
            ['reference' => 'PAY-2026-0003', 'member_email' => 'lina.chafik@example.com', 'subscription_reference' => 'SUB-2026-0003', 'type' => 'subscription', 'amount' => 349.000, 'status' => 'refunded', 'verified_at' => now()->subDays(39), 'refund_amount' => 349.000],
            ...
            ['reference' => 'PAY-2026-0005', 'member_email' => 'nadia.rachid@example.com', 'reservation_key' => 'nadia.rachid@example.com-'.now()->addDays(4)->toDateString().'-17:00:00', 'type' => 'reservation', 'amount' => 28.000, 'status' => 'refunded', 'verified_at' => now()->subDays(2), 'refund_amount' => 28.000],
        ...
        foreach ($paymentRows as $paymentRow) {
            ...
            Payment::query()->updateOrCreate(
                ...
                [
                    ...
                    'refund_amount' => $paymentRow['refund_amount'] ?? null,
                ],
            );
        }
    }
